...
# =========================================================
# II. FRONTEND - DAS DESIGN (AB JETZT NUR NOCH HIER ÄNDERN)
# =========================================================
st.set_page_config(page_title="WerkOS Pro", page_icon="🏗️", layout="wide")

# CSS für echtes App-Feeling (Sichtbarkeit garantiert!)
st.markdown("""
    <style>
...
if st.session_state.page == "🏠 Home":
    ...
    # Einträge anzeigen (Original Ampel-Design)
